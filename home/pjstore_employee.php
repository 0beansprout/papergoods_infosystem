...
<head>
  ...
  <title>JongieeGoods INC. | Store Employee</title>
...
try {
  ...
  try {
      ...
      $custSQL = $custDBH->prepare("INSERT INTO employees (empFirst, empLast, empEmail, empPassword, empDOB, empPhone, empPosition ) value (:efname, :elname, :eemail, :epass, :edob, :ephone, :eposition )");
  
      # bind some data values into the named parameters in the prepared statement
      $custSQL->bindParam(':efname', $_POST["ffirstname"]);
      $custSQL->bindParam(':elname', $_POST["flastname"]);
      $custSQL->bindParam(':eemail', $_POST["femail"]);
      $custSQL->bindParam(':epass', password_hash($_POST["fpassword"], PASSWORD_DEFAULT));
      $custSQL->bindParam(':edob', $_POST["fdob"]);
      $custSQL->bindParam(':ephone', $_POST["fphone"]);
        ...
        <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="alert alert-success"  role="alert">
                        <div class="card-body">
                        <h4><b>System Message:</b> Thanks for registering Employee.</h4>
                        </div>                   
                    </div>                   
