...
function Header()
{
    ...
    $this->Cell(65);
    // Title
    $this->Cell(50,10,'Customer Email Address Report',0,0,'C');
    // Line break
    $this->Ln(20);
}
...
$pdf->Cell(70,7,"Customer Name",1);
$pdf->Cell(70,7,"Email Address",1);
...
try {
	...
	while($row = $stmt->fetch()) {
        ...
        $pdf->Cell(70,7,$custFullName,0);
		$pdf->Cell(70,7,$row['custEmail'],0);
		// move the pointer to the beginning of the next line on the page
		$pdf->Ln();
	}
