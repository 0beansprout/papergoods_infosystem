...
<head>
  ...
  <title>Delete Order | JongieeGoods INC.</title>
...
try {
    ...
    $custSQL = $custDBH->prepare("DELETE FROM invoice WHERE invoiceID=:invoiceid");
        ...
        <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                     ...
                     <h4><b>System Message:</b> Customer Payment has been Deleted.</h4>
                     </div>                   
                    </div>
                    <br>		  
