...
<head>
  ...
  <title>Edit Employee | JongieeGoods INC.</title>
...
try {
    ...
    $custSQL = $custDBH->prepare("UPDATE employees 
    SET empFirst=:efname, empLast=:elname, empEmail=:eemail, empPassword=:epassword, empDOB=:edob, empPhone=:ephone, empPosition=:eposition 
    WHERE empID=:empid");

    # bind some data values into the named parameters in the prepared statement
    $custSQL->bindParam(':empid', $_POST["feid"]);
    $custSQL->bindParam(':efname', $_POST["fempfname"]);
    $custSQL->bindParam(':elname', $_POST["femplname"]);
    $custSQL->bindParam(':eemail', $_POST["fempemail"]);
    $custSQL->bindParam(':epassword', password_hash($_POST["femppassword"], PASSWORD_DEFAULT));
    $custSQL->bindParam(':edob', $_POST["fempdob"]);
    $custSQL->bindParam(':ephone', $_POST["fempphone"]);
    $custSQL->bindParam(':eposition', $_POST["fposition"]);
        ...
        <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                     ...
                     <h4><b>System Message:</b> Employee has been updated.</h4>
                     </div>                   
                     </div>                   
                    <br>		  
