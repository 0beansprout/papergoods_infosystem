...
<head>
  ...
  <title>Order New Product | JongieeGoods INC.</title>
...
try {
    ...
    $custSQL = $custDBH->prepare("INSERT INTO product (proName, proBrand, proQty, proPrice ) value (:pname, :pbrand, :pqty, :pprice )");
      ...
      <div id="content">
        ...
        <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                     <h4><b>System Message:</b> Product odering has been placed successfully.</h4>
                     </div>         
                     </div>                             
                    <br>		  
