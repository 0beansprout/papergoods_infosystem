...
<head>
  ...
  <title>Edit Product | JongieeGoods INC.</title>
...
try {
    ...
    $custSQL = $custDBH->prepare("UPDATE product 
    SET proID=:pid, proName=:pname, proBrand=:pbrand, proQty=:pqty, proPrice=:pprice 
    WHERE proID=:pid");

    # bind some data values into the named parameters in the prepared statement
    $custSQL->bindParam(':pid', $_POST["fpid"]);
    $custSQL->bindParam(':pname', $_POST["fproduct"]);
    $custSQL->bindParam(':pbrand', $_POST["fbrand"]);
    $custSQL->bindParam(':pqty', $_POST["fqty"]);
    $custSQL->bindParam(':pprice', $_POST["fprice"]);
      ...
      <div id="content">
        ...
        <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                     <h4><b>System Message:</b> Product has been updated.</h4>
                     </div> 
                     </div>                                     
                    <br>		  
