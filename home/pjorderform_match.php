...
<head>
  ...
  <title>Add New Order | JongieeGoods INC.</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">  <b>Add New Order</b></h1>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">If you click the "Add New Order" button, the form-data will be saved.</h6>
                    </div>
          ...
          <input type="hidden" name="fiid" value="<?php echo $invoiceid; ?>">
			...
			<div class="col-md-3">
    			<label for="exampleFormControlSelect1">Product Type:</label>
    				<select class="form-control" id="exampleFormControlSelect1" name = "fproduct" >
    			...
    			<label for="exampleFormControlSelect1">Brand Name:</label>
    				<select class="form-control" id="exampleFormControlSelect1" name = "fbrand" >
                    <option selected>Choose...</option>
			...
			<div class="form-row mb-3">
				<div class="col-md-4">
				  Total Cost:<br>
				  <input type="text" class="form-control" name="ftotalcost" placeholder="Total Cost" >
				  <br>
				</div>
        <div class="col-md-4">
				  Product ID:<br>
				  <input type="text" class="form-control" name="fbalance" placeholder="Product ID No.">
				  <br>
                </div>
            </div>
                <div class="form-row mb-3">
                ...
                <div class="col-md-6">
                  Description:<br>
                  <input type="text" class="form-control" name="fcomment" placeholder="Leave a comment...">
                  <br>
                  </div>
                  <div class="col-md-2">
                  Order Date:<br>
                  <input type="text" class="form-control" id="dateTimeField" name="fdate" placeholder="ex)2020-01-01">
                  <br>
                </div>
			</div>
