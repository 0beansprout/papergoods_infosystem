...
<head>
  ...
  <title>JongieeGoods INC. | Add Employee</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">  <b>Add New Employee</b></h1>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <form method = "POST" action="pjstore_employee.php">
    
                             <div class="form-row mb-3">
                                   <div class="col-md-4">
                                   First name:<br>
                                   <input type="text" class="form-control" name="ffirstname" value="" placeholder="Employee First Name">
                                   <br>
                             </div>
                                    <div class="col-md-4">
                                     Last name:<br>
                                     <input type="text" class="form-control" name="flastname" value="" placeholder="Employee Last Name">
                                    <br>
                                     </div>
                                </div>
                                <div class="form-row mb-3">
                                    <div class="col-md-8">
                                    Email Address:<br>
                                    <input type="email" class="form-control" name="femail" value="" placeholder="Employee Email Address">
                                     <br>
                                    </div>
                                 </div>
                                 <div class="form-row mb-3">
                                    <div class="col-md-8">
                                    Password:<br>
                                    <input type="password" class="form-control" name="fpassword" value="" placeholder="Password">
                                    <br>
                                 </div>
                                 ...
                                 <div class="form-row mb-3">
                                    <div class="col-md-4">
                                    Date of Birth:<br>
                                    <input type="text" class="form-control" name="fdob" value="" placeholder="ex. YYYY-MM-DD">
                                    <br>
                                    </div>
                                    <div class="col-md-4">
                                    Phone Number:<br>
                                     <input type="text" class="form-control" name="fphone" value="" placeholder="ex. 888-555-1234">
                                   <br>
                                </div>
                                </div>
                                <div class="form-row mb-3">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect1" name = "fposition" placeholder="ex. salesperson">
