...
<head>
  ...
  <title>Customer Re-Order | JongieeGoods INC.</title>
...
?>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">  <b>Customer Re-Order</b></h1>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">If you click the "Re-Order" button, the form-data will be saved.</h6>
                    </div>
      ...
      <button type = "submit" class="btn btn-success" href="pjstore_order.php"><i class="fas fa-cart-plus"></i> Re-Order</button>
				  <br><br>				  
