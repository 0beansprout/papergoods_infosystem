      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">  <b>Delete Employee</b></h1>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">If you click the "Confirm Delete" button, the employee will be removed.</h6>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="pjstore_deleted_employee.php">
                            ...
                            <input type="hidden" name="feid" value="<?php echo $empid; ?>">
                                ...
                                <div class="col-md-4">
                                 First name:<br>
                                 <input type="text" class="form-control" name="fempfname" disabled value="<?php echo $empfname; ?>">
                                <br>
                                </div>
                                <div class="col-md-4">
                                 Last name:<br>
                                 <input type="text" class="form-control" name="femplname" disabled value="<?php echo $emplname; ?>">
                                <br>
                            </div>
                        </div>
                            <div class="form-row mb-3">
                                <div class="col-md-8">
                                Email Address:<br>
                                <input type="email" class="form-control" name="fempemail" disabled value="<?php echo $empemail; ?>">
                                <br>
                                </div>
                            </div>
                            <div class="form-row mb-3">
                                <div class="col-md-4">
                                Password:<br>
                                <input type="password" class="form-control" name="femppassword" disabled value="<?php echo $emppassword; ?>">
                                <br>
                                </div>
                                <div class="col-md-4">
                                Date of Birth:<br>
                                <input type="text" class="form-control" name="fempdob" disabled value="<?php echo $empdob; ?>">
                                <br>
                                </div>
                                </div>
                                <div class="form-row mb-3">
                                <div class="col-md-4">
                                Phone Number:<br>
                                <input type="text" class="form-control" name="fempphone" disabled value="<?php echo $empphone; ?>">
                                <br>
                                </div>
                                <div class="col-md-4">
                                Position:<br>
                                <input type="text" class="form-control" name="fempposition" disabled value="<?php echo $empposition; ?>">
                                <br>
                                </div>
                            </div>
                            ...
                            <ul class="nav"><br>  
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal2"><i class="fas fa-user-slash"></i>
                             Delete Employee
                            </button>
                            <!-- Modal --> 
