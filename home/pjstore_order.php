...
<head>
  ...
  <title>Store Customer Order | JongieeGoods INC.</title>
...
try {
    ...
    $custSQL = $custDBH->prepare("INSERT INTO invoice (custID, custFname, custLname, invoiceProduct, invoiceBrand, invoiceQty, invoiceTotalCost, invoiceBalance, invoiceComment, invoiceDate ) value (:cid, :cfname, :clname, :iproduct, :ibrand, :iqty, :itotalcost, :ibalance, :icomment, :idate )");
      ...
      <div id="content">
        ...
        <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                     <h4><b>System Message:</b> Customer Ordering has been placed successfully.</h4>
                     </div>                   
                     </div>                   
                    <br>		  
