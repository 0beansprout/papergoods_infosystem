...
<head>
  ...
  <title>Add New Product | JongieeGoods INC.</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">  <b>Add New Product</b></h1>
                ...
                <div class="card shadow mb-4">
                    ...
                    <form method = "POST" action="pjstore_product.php">
            ...
            <div class="form-row mb-3">
				...
				<div class="col-md-6">
				  Price ($):<br>
				  <input type="text" class="form-control" name="fprice" placeholder="Price" >
				  <br>
				</div>
