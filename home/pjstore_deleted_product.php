...
try {
    ...
    $custSQL = $custDBH->prepare("DELETE FROM product WHERE ProID=:productid");

    # bind some data values into the named parameters in the prepared statement
    $custSQL->bindParam(':productid', $_POST["fpid"]);
      ...
      <div id="content">
        ...
        <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                     <h4><b>System Message:</b> Product has been deleted.</h4>
                     </div>     
                     </div>                                 
                    <br>		  
