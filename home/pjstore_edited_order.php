...
<head>
  ...
  <title>Store Payment | JongieeGoods INC.</title>
...
try {
    ...
    $custSQL = $custDBH->prepare("UPDATE invoice 
    SET custID=:cid, custFname=:cfname, custLname=:clname, invoiceProduct = :iproduct, invoiceBrand = :ibrand, invoiceQty = :iqty, invoiceTotalCost=:itotalcost, invoiceBalance=:ibalance, invoiceComment=:icomment, invoiceDate=:idate
    WHERE invoiceID=:invoiceid");

    # bind some data values into the named parameters in the prepared statement
    $custSQL->bindParam(':invoiceid', $_POST["fiid"]);
    $custSQL->bindParam(':cid', $_POST["fcid"]);
    $custSQL->bindParam(':cfname', $_POST["ffirstname"]);
    $custSQL->bindParam(':clname', $_POST["flastname"]);
    $custSQL->bindParam(':iproduct', $_POST["fproduct"]);
    $custSQL->bindParam(':ibrand', $_POST["fbrand"]);
    $custSQL->bindParam(':iqty', $_POST["fqty"]);
    $custSQL->bindParam(':itotalcost', $_POST["ftotalcost"]);
    $custSQL->bindParam(':ibalance', $_POST["fbalance"]);
    $custSQL->bindParam(':icomment', $_POST["fcomment"]);
    $custSQL->bindParam(':idate', $_POST["fdate"]);
        ...
        <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                     ...
                     <h4><b>System Message:</b> Customer Order has been Updated.</h4>
                     </div>   
                    </div>                
                    <br>		  
