...
<head>
  ...
  <title>JongieeGoods INC. | Store Customer</title>
...
try {
    ...
    $custSQL = $custDBH->prepare("INSERT INTO customers (custFname, custLname, custEmail, custAddress, custCity, custState ) value (:cfname, :clname, :cemail, :caddress, :ccity, :cstate )");
    ...
    $custSQL->bindParam(':cemail', $_POST["femail"]);
    $custSQL->bindParam(':caddress', $_POST["faddress"]);
    $custSQL->bindParam(':ccity', $_POST["fcity"]);
    $custSQL->bindParam(':cstate', $_POST["fstate"]);
        ...
        <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                     ...
                     <h4><b>System Message:</b> Thanks for registering Customer.</h4>
                     </div>     
                     </div>                   
