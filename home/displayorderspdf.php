...
$pdf->Cell(12,7,"Order No.",1);
$pdf->Cell(9,7,"CustID",1);
$pdf->Cell(24,7,"Customer Name",1);
$pdf->Cell(10,7,"ProID",1);
$pdf->Cell(21,7,"Product",1);
$pdf->Cell(25,7,"Brand",1);
$pdf->Cell(10,7,"Qty",1);
$pdf->Cell(12,7,"Cost",1);
$pdf->Cell(18,7,"Comment",1);
$pdf->Cell(18,7,"Date",1);
...
try {
	...
	$stmt = $conn->query('SELECT * from invoice ORDER BY invoiceID');
