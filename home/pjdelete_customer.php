...
<head>
  ...
  <title>Delete Customer | JongieeGoods INC.</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">  <b>Delete Customer</b></h1>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">If you click the "Confirm Delete" button, the customer will be removed.</h6>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="pjstore_deleted_customer.php">
                            ...
                            <input type="hidden" name="fcid" value="<?php echo $custid; ?>">
                                ...
                                <div class="col-md-4">
                                 First name:<br>
                                <input type="text" class="form-control" name="fcustfname" disabled  value="<?php echo $custfname; ?>">
                                <br>
                                </div>
                                <div class="col-md-4">
                                 Last name:<br>
                                <input type="text" class="form-control" name="fcustlname" disabled value="<?php echo $custlname; ?>">
                                <br>
                            </div>
                        </div>
                            <div class="form-row mb-3">
                                <div class="col-md-8">
                                Email Address:<br>
                                <input type="email" class="form-control" name="fcustemail" disabled value="<?php echo $custemail; ?>" >
                                <br>
                                </div>
                            </div>
                            <div class="form-row mb-3">
                                <div class="col-md-3">
                                Street Address:<br>
                                <input type="text" class="form-control" name="fcustaddress" disabled value="<?php echo $custaddress; ?>" >
                                <br>
                                </div>
                                <div class="col-md-3">
                                City:<br>
                                <input type="text" class="form-control" name="fcustcity" disabled value="<?php echo $custcity; ?>">
                                <br>
                                </div>
                                <div class="col-md-2">
                                State:<br>
                                <input type="text" class="form-control" name="fcuststate" disabled value="<?php echo $custstate; ?>">
                                <br>
                                </div>
                            </div>
